...
const carouselSlides = [
  {
    ...
    description: 'Encuentra tu fragancia perfecta en nuestra exclusiva colección de perfumes.',
  ...
  },
  {
    ...
    description: 'Rutinas y productos para una piel radiante y saludable.',
  ...
  {
    id: 'carousel-hair',
    title: 'Cabello Sano y Brillante',
    description: 'Descubre nuestros tratamientos y productos para todo tipo de cabello.',
    buttonText: 'Explorar Cuidado Capilar',
    href: '#',
    imageHint: 'hair products',
  },
  {
    id: 'carousel-body',
    title: 'Bienestar de Pies a Cabeza',
    description: 'Mima tu cuerpo con nuestras cremas, aceites y exfoliantes.',
    buttonText: 'Comprar Cuidado Corporal',
    href: '#',
